 ...
 *
 * */
data class ApiError(val message: String?, val code: Int?, var errorStatus: ErrorStatus,val error:Boolean?) {

    constructor(message: String?, errorStatus: ErrorStatus) : this(message, null, errorStatus,true)
